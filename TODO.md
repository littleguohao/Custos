...
>
> 最后更新：2026-08-12（#51 冷却机制落地：止损冷却名单（日/周/月报）+ 月胜率降仓提示节（v0.48），完成删除；#45② 落地：as_of 补进三段契约（v0.47），完成删除；#13 gate 语义修正：新 gate bottom_surge_j13 / bottom_surge_strict_j13，待目标机回测（v0.47）；决策项裁决落盘：#25 定范围（只扫 0AMV×出场组合）移入 P2、#26 扩为板块信息整体优化、#31 并入 #51、#37/#38 合并为 1800 重构、#32 改「先梳理再 strict」；前次：去冗精简，有结论/已落地条目删除，事实归宿在 R 系列文档与 CHANGELOG）
