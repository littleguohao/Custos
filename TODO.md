...
>
> 最后更新：2026-09-14（#63 解析器下沉落地（v0.225）：tdxhy.cfg/incon.dat/
> blocknew.cfg/.blk 纯格式解析下沉 `datasource/local_tdx/tdx_block_files.py`，
> 两处门面 re-export。此前 2026-09-13：#67 迁移完成 + #76② 生产机回测闭环）。
