...
用法:
  ...
  uv run python src/custos/datasource/local_tdx/fetch_market_cap.py --since 2018 --freq month
  # 指定交易日补采
  uv run python src/custos/datasource/local_tdx/fetch_market_cap.py --dates 2024-06-28 2024-09-30
  # 查询某日股本/市值
  uv run python src/custos/datasource/local_tdx/fetch_market_cap.py --as-of 2024-07-15 --code 600000
  # 自检
