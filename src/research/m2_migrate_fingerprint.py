...
用法：
    uv run python src/research/m2_migrate_fingerprint.py            # 预览
    uv run python src/research/m2_migrate_fingerprint.py --apply    # 执行
"""
...
def main() -> int:
    ...
    print(f"\n已重命名 {done} 个文件。现在跑："
          f"\n  uv run python src/research/m2_stop_sweep.py --sample 1000"
