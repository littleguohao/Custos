...
用法：
    uv run python src/research/probe_data_sources.py                # 全部
    uv run python src/research/probe_data_sources.py --only tq      # 只探 TQ
    uv run python src/research/probe_data_sources.py --repeat 5     # 每项跑 5 次
"""
...
for _p in ("src/core", "src/datasource/local_tdx", "src/pipeline/screening",
           "src/pipeline/market_timing"):
