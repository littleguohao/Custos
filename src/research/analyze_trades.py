...
用法:
    uv run python src/research/analyze_trades.py              # 默认输出到 artifacts/reports/
    uv run python src/research/analyze_trades.py --preview    # 仅打印数据概览
    uv run python src/research/__main__.py analyze_trades     # 经统一研究入口
"""
