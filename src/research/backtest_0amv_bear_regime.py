...
CLI::
    ...
    uv run python src/research/backtest_0amv_bear_regime.py
    uv run python src/research/backtest_0amv_bear_regime.py --start 2020-07-10 --end 2026-07-09
"""
...
from paths import BASE, cn_now, REVIEWS, TRADES_DIR  # noqa: E402
