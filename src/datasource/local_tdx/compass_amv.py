...
CLI::
    ...
    uv run python src/datasource/local_tdx/compass_amv.py            # summary JSON
    uv run python src/datasource/local_tdx/compass_amv.py --since 2026-07-01
    uv run python src/datasource/local_tdx/compass_amv.py --json     # 全量记录
"""
...
from paths import BASE, MARKET_DIR  # noqa: E402,F401  (照 src 惯例统一入口)
