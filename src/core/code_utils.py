...
src/core/trades/incremental_ledger.py, src/core/trades/standardize_trades.py,
src/pipeline/market_timing/technical_monitor.py and
src/pipeline/holdings/holding_sector_mapper.py.
