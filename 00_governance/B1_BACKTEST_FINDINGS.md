...
11. **0AMV 入场择时"迟到"~23交易日(起涨点研究,2024-09~2025-06)**：多头区间涨最好的赢家,其系统可选起涨点
    (reversal_k,排除0AMV)**98% 落在空头**,空头转做多**中位领先23交易日**(p25 9/p75 58/max 77)。
    ⚠️ **事后/幸存者视角**:赢家与起涨点都后视选出(挑了底部),且**只数赢家起涨、未计空头里的飞刀**。
    **不能推出"放宽0AMV"**——已证空头广撒 B1 = -EV(熊市-46%,加板块过滤仍-42%),赢家与飞刀都在空头见底、实时分不出。
    0AMV 迟到 = 避开空头屠杀的**代价/权衡**,非错误。要吃这~23天须**实时判别子**:价量(无alpha)、板块相位(单独不够,-42%)均不行;
    ...
    **前哨机制已就位**:candidate_table 观察区里标 `待0AMV做多` 者=基本面优+板块有利+技术强但0AMV未多头,正是候选早期起涨
    ...
    - **多窗复核(4窗)→ 领先量极不稳定**:反弹22春 **0%空头(0AMV当时及时/领先,起涨点全落做多)**、22冬 96%空头/领先中位5天、
      24春 61%/中位53天、2024-09 98%/中位23天。**没有可机械化的固定提前量**(0→53天,窗内p25-p75 2~58天)。
