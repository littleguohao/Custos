...
| [R4](R4_timing_amv_sector.md) | 0AMV + 板块相位 | 0AMV ~15pp、板块 ~4–6pp | L4 | ✅ **成立** |
...
| 优先级 | 单元 | 不稳的是什么 | 方向会变吗 |
|---|---|---|---|
| **P0** | [R4](R4_timing_amv_sector.md) 0AMV+板块 | **两个验证窗全在 2021-08 之后 ⇒ 只可能来自已弃用的 `2021_2026` bundle**。该 bundle 加法调整（收益放大 13~21%）、universe≈在市股 ⇒ **「含退市 OOS 验证」很可能不成立** | 方向大概率稳（四格同样放大），但**「已去偏」这个资格要重新取得** |
