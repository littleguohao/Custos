...
0. **【核心思想，owner 2026-08-19 定案】不追求胜率，追求「一定胜率基础上的更高盈亏比」，
   盈利通过优化止盈止损和仓位管理达成。** 推论：① 评价任何信号/方案，看**期望与盈亏比**，
   不把胜率当目标（胜率只要不低于支撑盈亏比的底线）；② 改进杠杆优先加在**出场（止盈止损）
   与仓位管理**上，而不是继续打磨入场精度；③ 研究口径与此一致：R2 已证「选股无 alpha」，
   出场侧（止损余量、移动止盈、0AMV 择时）是既有研究里少数反复过线的地方。
