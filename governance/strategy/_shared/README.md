...
| 持仓主线 owner 指定表 | [holding_mainline_overrides.json](holding_mainline_overrides.json) | ✅ live（2026-08-29 首版，v0.145） | 表内 note 即 owner 指定理由；换仓时由 owner 增删（theme_tracker 解析链第①层） |
