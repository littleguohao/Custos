...
flowchart TB
    ...
    subgraph SEL["选股方向 —— 已关闭"]
        ...
        R29["R29 胜率稳定≥40%+盈亏比≥2.4<br/>📋 预注册（跑数前）<br/>权重向 pre2019 稳定腿倾斜"]
    end
...
| [R29](R29_score_stability_rebuild.md) | 胜率稳定≥40% + 盈亏比≥2.4 打分重建 | 📋 预注册：权重向 pre2019 不萎缩的腿倾斜（rsi_bull_div/macd底背离各 30），regime 锚 rsi_deep 降权至归零；W1-W4 四候选 + R29-C1~C4 判据跑数前写死；工程载体 score_stability_study.py（Phase2/3 镜像 R24） | L3 | 📋 预注册（2026-09-07，跑数前）|
