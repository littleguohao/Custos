...
flowchart TB
    ...
    subgraph SEL["选股方向 —— 已关闭"]
        ...
        R36["R36 完美B1正例监督式打分<br/>🔄 Phase1✅诊断回填/V0落点8/10前20%<br/>Phase2独苗终审否决<br/>Phase3调权格跑数中"]
    end
