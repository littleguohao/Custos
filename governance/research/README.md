...
flowchart TB
    ...
    subgraph SEL["选股方向 —— 已关闭"]
        ...
        R36["R36 完美B1正例监督式打分<br/>📋 预注册（Phase0✅ 审计落档）<br/>发现/验证分离<br/>终点=高盈亏比标的"]
    end
...
| [R36](R36_perfect_b1_supervised_scoring.md) | 完美 B1 正例监督式打分研究 | 📋 预注册：发现/验证分离写死（10 例 L1 发现材料，全部 2025 年单一 regime + 买点事后标注）；Phase 0 ✅ 数据审计落档（10/10 加载，涨幅 +11.2%~+207.9% 全正，买点当日 7/10 缩量小阴 0/10 涨停附近）；判据 R36-C1~C5（C2 全宇宙双窗 margin>0 同向 / C3 零翻转 / C4 打过随机臂 / C5 pre2019 一票否决；正例召回率永远不作判据）；验证宇宙剔除 10 案例股防发现泄漏 | L1 样本 / L3− | 📋 预注册（2026-09-16 落档，Phase 0 ✅）|
