...
**核心原则：数据采集和因子计算全部由 Python 脚本完成，LLM 参与数据和消息分析、市场信息判断、因子研究。**

LLM 不进 live 交易决策与执行链路——live 保持纯脚本（研究侧边界见
[`research/README.md`](governance/research/README.md)「LLM 进化引擎口径」）。
